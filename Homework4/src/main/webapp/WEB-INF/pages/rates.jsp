...
<div class="wrapper">
	...
	<p></p>
	    <div class="cur_body">
			<form:form method="post" action="/HomeWork4/api/rate/add" commandName="rate" class="form-horizontal">
			<div>
			...
			<div class="control-group">
				<div class="controls">
					<input type="button" class="pat_btn_click" onclick="location.href='/HomeWork4/welcome'" value="Back" >
				</div>
			</div>
				<p></p>
		</div>
